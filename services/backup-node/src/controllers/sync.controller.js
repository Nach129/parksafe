...
async function synchronizeSnapshot(req, res, next) {
  ...
  try {
    ...
    /*
     * Eliminamos primero las tablas dependientes.
     */
    ...
    for (const space of spaces) {
      ...
      await connection.execute(
        ...
        [
          ...
          space.vehiculo_id === null ? null : Number(space.vehiculo_id),
    ...
    /*
     * Las operaciones que vienen del nodo vigente
     * se consideran ya aplicadas.
     */
